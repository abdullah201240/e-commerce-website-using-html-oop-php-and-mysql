...
<html lang="en">
  ...
  <a class="navbar-brand" href="home.php">Rain Water</a>
...
<br>
<center> <h1 style='color:white'>My Cart</h1> </center>
<br>
<table class="table table-dark">
  ...
  <?php foreach ($data as $da): ?>
    <tr>
     ...
     echo"<a href='deleteorder.php?id=$did'><button type='button' class='btn btn-danger'>Delete</button></a> ";
    ?>
    </td>
...
<center>
<a href="buynow.php"><button type="button" class="btn btn-success">Buy Now</button></a>
</center>
